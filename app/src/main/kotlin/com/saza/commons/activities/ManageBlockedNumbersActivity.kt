...
import com.saza.commons.compose.extensions.onEventValue
import com.saza.commons.compose.screens.ManageBlockedNumbersScreen
import com.saza.commons.compose.theme.AppThemeSurface
import com.saza.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.saza.commons.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.saza.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.saza.dialer")) {

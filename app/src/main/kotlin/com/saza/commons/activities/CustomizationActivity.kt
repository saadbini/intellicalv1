...
import com.saza.intellical.databinding.ActivityCustomizationBinding
import com.saza.commons.dialogs.*
import com.saza.commons.extensions.*
import com.saza.commons.helpers.*
import com.saza.commons.models.MyTheme
import com.saza.commons.models.RadioItem
import com.saza.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.saza.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.saza.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }

...
import com.saza.commons.models.AlarmSound
import com.saza.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.saza.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.saza.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.saza.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.saza."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.saza.contacts") && !packageName.startsWith("com.saza.dialer")) {
        true
    } else if ((packageName.startsWith("com.saza.contacts") || packageName.startsWith("com.saza.dialer")) && isQPlus()) {
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.copyright), text)

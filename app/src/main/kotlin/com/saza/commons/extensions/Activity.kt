...
import com.saza.intellical.databinding.DialogTitleBinding
import com.saza.commons.dialogs.*
import com.saza.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.saza.commons.helpers.*
import com.saza.commons.models.*
import com.saza.commons.views.MyTextView
import java.io.*
import java.util.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.saza.gallery.pro" || applicationId == "com.saza.gallery.pro.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.saza.dialer.debug" else "com.saza.dialer"
                val className = "com.saza.dialer.activities.DialerActivity"

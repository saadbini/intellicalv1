...
import com.saza.intellical.databinding.MonthViewBackgroundBinding
import com.saza.intellical.databinding.MonthViewBinding
import com.saza.intellical.extensions.config
import com.saza.intellical.helpers.COLUMN_COUNT
import com.saza.intellical.helpers.ROW_COUNT
...
class MonthViewWrapper(context: Context, attrs: AttributeSet, defStyle: Int) : FrameLayout(context, attrs, defStyle) {
    ...
    private fun setupHorizontalOffset() {
        horizontalOffset = if (context.config.showWeekNumbers) {
            resources.getDimensionPixelSize(R.dimen.smaller_text_size) * 2
        } else {
            0
        }
    }

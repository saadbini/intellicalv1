...
import com.saza.intellical.adapters.MyWeekPagerAdapter
import com.saza.intellical.databinding.FragmentWeekHolderBinding
import com.saza.intellical.databinding.WeeklyViewHourTextviewBinding
import com.saza.intellical.extensions.*
import com.saza.intellical.helpers.Formatter
import com.saza.intellical.helpers.WEEKLY_VIEW
import com.saza.intellical.helpers.WEEK_START_DATE_TIME
import com.saza.intellical.interfaces.WeekFragmentListener
import com.saza.intellical.views.MyScrollView
...
class WeekFragmentsHolder : MyFragmentHolder(), WeekFragmentListener {
    ...
    override fun getFullFragmentHeight(): Int {
        val dividerHeight = resources.getDimensionPixelSize(com.saza.intellical.R.dimen.divider_height)
        return binding.weekViewHolder.height - binding.weekViewSeekbar.height - dividerHeight
    }

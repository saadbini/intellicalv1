...
import com.saza.intellical.extensions.scheduleCalDAVSync
import com.saza.commons.extensions.getDefaultAlarmTitle
import com.saza.commons.helpers.BaseConfig
import com.saza.commons.helpers.DAY_MINUTES
import com.saza.commons.helpers.YEAR_SECONDS
import java.util.*
...
class Config(context: Context) : BaseConfig(context) {
    ...
    var useNaturalLanguageEventCreation: Boolean
        get() = true  // Always enabled since we've simplified to use only the local parser
        set(useNaturalLanguageEventCreation) = prefs.edit().putBoolean("use_natural_language_event_creation", useNaturalLanguageEventCreation).apply()
    ...
    // Natural language project name and deployment name settings have been removed
    // These values are now hardcoded in NaturalLanguageParser.kt
}

...
const val SHORTCUT_NEW_NATURAL_LANGUAGE_EVENT = "shortcut_new_natural_language_event"
...
const val REPEAT_RULE_MONTHLY = 1
const val REPEAT_RULE_YEARLY = 2
...
const val CALENDAR_PRODID = "PRODID:-//IntelliCal//NONSGML Event Calendar//EN"
...
// Natural Language event creation is now hardcoded
// All configuration is handled internally, with no user-configurable settings

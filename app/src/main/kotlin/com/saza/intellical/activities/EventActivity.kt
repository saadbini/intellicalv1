...
import com.saza.intellical.adapters.AutoCompleteTextViewAdapter
import com.saza.intellical.databinding.ActivityEventBinding
import com.saza.intellical.databinding.ItemAttendeeBinding
import com.saza.intellical.dialogs.*
...
import com.saza.commons.dialogs.ConfirmationAdvancedDialog
...
import com.saza.commons.views.MyAutoCompleteTextView
...
class EventActivity : SimpleActivity() {
    ...
    private fun setupNewEvent() {
        ...
        if (intent.action == Intent.ACTION_EDIT || intent.action == Intent.ACTION_INSERT) {
            ...
            intent.getStringExtra(LOCATION)?.let { location ->
            ...
            // Get END timestamp and apply same conversion logic
            ...
            // Process extras from NaturalLanguageEventActivity or other sources
            intent.getStringExtra(TITLE)?.let { title ->
                binding.eventTitle.setText(title)
            }
    ...
    private fun updateReminderTypeImage(view: ImageView, reminder: Reminder) {
        ...
        val drawable = if (reminder.type == REMINDER_NOTIFICATION) {
            R.drawable.ic_bell_vector
        } else {
            R.drawable.ic_mail_vector
        }
